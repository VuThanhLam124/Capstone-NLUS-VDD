...
TPCDS_TABLES = {
    ...
    "store": {
        "alias": "s",
        "columns": ["s_store_sk", "s_store_id", "s_rec_start_date", "s_rec_end_date",
    ...
    "web_site": {
        "alias": "web",
        "columns": ["web_site_sk", "web_site_id", "web_rec_start_date", "web_rec_end_date",
    ...
    "web_page": {
        "alias": "wp",
        "columns": ["wp_web_page_sk", "wp_web_page_id", "wp_rec_start_date", "wp_rec_end_date",
    ...
    "call_center": {
        "alias": "cc",
        "columns": ["cc_call_center_sk", "cc_call_center_id", "cc_rec_start_date", "cc_rec_end_date",
    ...
    "promotion": {
        ...
        "columns": ["p_promo_sk", "p_promo_id", "p_start_date_sk", "p_end_date_sk", "p_item_sk",
                   "p_cost", "p_response_target", "p_promo_name", "p_channel_dmail",
                   "p_channel_email", "p_channel_catalog", "p_channel_tv", "p_channel_radio",
                   "p_channel_press", "p_channel_event", "p_channel_demo", "p_channel_details",
...
COLUMN_SEMANTICS = {
    ...
    "gender": ["cd_gender"],
    "giới tính": ["cd_gender"],
    "birth year": ["c_birth_year"],
    "sinh nam": ["c_birth_year"],
    "sinh năm": ["c_birth_year"],
    "birth month": ["c_birth_month"],
    "sinh thang": ["c_birth_month"],
    "sinh tháng": ["c_birth_month"],
    "birth day": ["c_birth_day"],
    "sinh ngay": ["c_birth_day"],
    "sinh ngày": ["c_birth_day"],
    "quoc tich": ["c_birth_country"],
    "quốc tịch": ["c_birth_country"],
    "quoc gia": ["c_birth_country", "ca_country"],
    "quốc gia": ["c_birth_country", "ca_country"],
    "country": ["c_birth_country", "ca_country"],
    "email": ["c_email_address"],
    "login": ["c_login"],
    "salutation": ["c_salutation"],
    "uu tien": ["c_preferred_cust_flag"],
    "ưu tiên": ["c_preferred_cust_flag"],
    "preferred": ["c_preferred_cust_flag"],
    "thue": ["ss_ext_tax", "web_tax_percentage"],
    "thuế": ["ss_ext_tax", "web_tax_percentage"],
    "tax": ["ss_ext_tax", "web_tax_percentage"],
    "giam gia": ["ss_ext_discount_amt", "ws_ext_discount_amt", "cs_ext_discount_amt"],
    "giảm giá": ["ss_ext_discount_amt", "ws_ext_discount_amt", "cs_ext_discount_amt"],
    "discount": ["ss_ext_discount_amt", "ws_ext_discount_amt", "cs_ext_discount_amt"],
